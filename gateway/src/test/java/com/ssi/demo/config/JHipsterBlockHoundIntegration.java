...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ssi.demo.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ssi.demo.security.DomainUserDetailsService", "createSpringSecurityUser");
